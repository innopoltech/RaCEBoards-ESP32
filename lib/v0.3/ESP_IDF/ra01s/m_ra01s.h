...
#define RADIO_PIN_NUM_CS        GPIO_NUM_7
#define RADIO_PIN_NUM_RESET     GPIO_NUM_6
#define RADIO_PIN_NUM_BUSY      GPIO_NUM_5

#define RADIO_ENABLE_INFO         true
#define RADIO_ENABLE_ERROR        true


//return values
#define SX1261_ERR_NONE                        0
#define SX1261_ERR_PACKET_TOO_LONG             1
#define SX1261_ERR_UNKNOWN                     2
#define SX1261_ERR_TX_TIMEOUT                  3
#define SX1261_ERR_RX_TIMEOUT                  4
#define SX1261_ERR_CRC_MISMATCH                5
#define SX1261_ERR_WRONG_MODEM                 6
#define SX1261_ERR_INVALID_BANDWIDTH           7
#define SX1261_ERR_INVALID_SPREADING_FACTOR    8
#define SX1261_ERR_INVALID_CODING_RATE         9
#define SX1261_ERR_INVALID_FREQUENCY_DEVIATION 10
#define SX1261_ERR_INVALID_BIT_RATE            11
#define SX1261_ERR_INVALID_RX_BANDWIDTH        12
#define SX1261_ERR_INVALID_DATA_SHAPING        13
#define SX1261_ERR_INVALID_SYNC_WORD           14
#define SX1261_ERR_INVALID_OUTPUT_POWER        15
#define SX1261_ERR_INVALID_MODE                16
#define SX1261_ERR_INVALID_TRANCEIVER          17

// SX126X physical layer properties
#define SX1261_XTAL_FREQ                       ( float )32000000
#define SX1261_FREQ_DIV                        ( float )pow( 2.0, 25.0 )
#define SX1261_FREQ_STEP                       ( float )( SX1261_XTAL_FREQ / SX1261_FREQ_DIV )
...
esp_err_t ra01s_setChannel(uint8_t ch_);    //1-6
